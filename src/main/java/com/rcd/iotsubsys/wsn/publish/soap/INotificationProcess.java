 ...
 *
 */
@WebService(targetNamespace = "http://com.rcd.iotsubsys.wsn.publish.soap",name = "INotificationProcess")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
public interface INotificationProcess{
	public String notificationProcess(@WebParam(partName = "Wsn", name = "WsnProcess",
        targetNamespace = "http://com.rcd.iotsubsys.wsn.publish.soap") String notification);
}
